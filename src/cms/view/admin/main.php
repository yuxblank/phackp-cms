...
<head>
    ...
    <title></title>
    <link href="<?php echo $APP_URL ?>/resource/lachance/css/uikit.gradient.css" rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL ?>/resource/lachance/css/components/form-select.gradient.min.css"
          rel="stylesheet" type="text/css">
    <link href="<?php echo $APP_URL ?>/resource/lachance/css/components/form-advanced.gradient.min.css"
          rel="stylesheet" type="text/css">
    <link href="<?php echo $APP_URL ?>/resource/lachance/css/components/notify.css" rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL ?>/resource/lachance/css/components/placeholder.gradient.css"
          type="text/css" rel="stylesheet">
    <script src="<?php echo $APP_URL ?>/resource/lachance/js/jquery-1.11.3.min.js"></script>
    <script src="<?php echo $APP_URL ?>/resource/lachance/js/uikit.js"></script>
    <script src="<?php echo $APP_URL ?>/resource/lachance/js/components/notify.js"></script>
    <script src="<?php echo $APP_URL ?>/resource/lachance/js/components/form-select.min.js"></script>
    <?php
...
<?php } ?>
    ...
    <div id="offcanvas" class="uk-offcanvas">
        <?php
        if (isset($adminMenu)):
            include_once 'includes/main-menu-offcanvas.php';
        endif;
        ?>
