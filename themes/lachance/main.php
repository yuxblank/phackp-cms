...
<head>
    ...
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/components/slideshow.min.css" rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/components/dotnav.min.css" rel="stylesheet"
          type="text/css">
    ...
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/components/notify.min.css" rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/components/accordion.gradient.min.css"
          rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/jquery.cookiebar.min.css" rel="stylesheet"
          type="text/css">
    <link href="<?php echo $APP_URL; ?>/resource/lachance/css/lachance.min.css" rel="stylesheet"
          type="text/css">

    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $APP_URL; ?>/resource/lachance/images/icon/favicon-16x16.png">
    ...
    <meta name="msapplication-TileImage" content="<?php echo $APP_URL; ?>/resource/lachance/images/icon/ms-icon-144x144.png">
    ...
    <script src="<?php echo $APP_URL; ?>/resource/lachance/js/components/accordion.min.js"></script>
...
<div class="yx-maincontainer uk-container uk-container-center" data-uk-margin>
    <div class="yx-header uk-margin-large-bottom">
        <header class="uk-grid uk-container-center uk-hidden-small"
                data-uk-grid-match>
            <nav class="uk-navbar">
                    <a class="uk-navbar-brand" href="<?php echo $APP_URL; ?> "><img class="yx-logo"
    ...
    <div class="yx-mobile-header uk-visible-small">
        <div class="uk-grid">
            <div class="logo uk-width-4-10">
    ...
    <div class="yx-page-content uk-margin uk-animation uk-animation-scale-up">
        <?php $this->content() ?>
    </div>
    ...
    <div class="yx-bottom uk-margin uk-animation uk-animation-fade">

        <div class="uk-grid uk-container-center uk-grid-width-medium-1-3" data-uk-margin>
            <div class="uk-panel uk-panel-box uk-panel-box-primary">
                <div class="uk-panel-header">
                    <h3 class="uk-panel-title">Informazioni</h3>
                </div>
                <?php if(isset($informazioni)): ?>
                    <ul class="uk-nav">
                        <?php foreach($informazioni as $info): ?>
                            <li><a href="<?php echo $this->router->link('informazioni/{alias}/{id}', array($info->alias,$info->id)) ?>"> <?php echo $info->title ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
            </div>
            <div class="uk-panel uk-panel-box uk-panel-box-primary">
                <div class="uk-panel-header">
                    <h3 class="uk-panel-title">A proposito di noi...</h3>
                </div>

                <ul class="uk-list uk-list-space">
                    <li><i class="uk-icon-medium uk-icon-clock-o"></i><span style="padding: 5px"> Siamo aperti tutti i giorni escluso il martedì, dalle 18:00 alle 22:00</span></li>
                    <li><i class="uk-icon-medium uk-icon-map-marker"></i> <span style="padding: 5px"> Frazione Borrettaz N°5B, 11020 Aosta</span></li>
                    <li><i class="uk-icon-medium uk-icon-phone"></i><span style="padding: 5px"> 335 5739358</span></li>
                    <li><i class="uk-icon-medium uk-icon-info"></i><span style="padding: 5px"> Partita IVA: 01192840070</span></li>
                </ul>
